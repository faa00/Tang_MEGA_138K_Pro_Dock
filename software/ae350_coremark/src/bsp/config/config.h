...
// UART1 with DMA
// TX
#define DRV_UART1_DMA_TX_EN             0		// Enable/disable UART1 DMA TX	1: enable; 0: disable
#define DRV_UART1_DMA_TX_CH             0		// DMA channel number of UART1 TX
#define DRV_UART1_DMA_TX_REQID          4		// DMA request id of UART1 TX
// RX
#define DRV_UART1_DMA_RX_EN             0		// Enable/disable UART1 DMA RX	1: enable; 0: disable
...
// UART2 with DMA
// TX
#define DRV_UART2_DMA_TX_EN             0		// Enable/disable UART2 DMA TX	1: enable; 0: disable
#define DRV_UART2_DMA_TX_CH             0		// DMA channel number of UART2 TX
#define DRV_UART2_DMA_TX_REQID          6		// DMA request id of UART2 TX
// RX
#define DRV_UART2_DMA_RX_EN             0		// Enable/disable UART2 DMA RX	1: enable; 0: disable
